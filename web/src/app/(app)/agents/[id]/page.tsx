                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-white/10">
                        <th className="pb-3 text-left font-medium text-zinc-400">Service</th>
                        <th className="pb-3 text-left font-medium text-zinc-400">Amount</th>
                        <th className="pb-3 text-left font-medium text-zinc-400">Status</th>
                        <th className="pb-3 text-left font-medium text-zinc-400">Date</th>
                        <th className="pb-3 text-left font-medium text-zinc-400">TX</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-white/5">
                      {agent.transactions.map((tx) => (
                        <tr key={tx.id}>
                          <td className="py-3 text-zinc-200">{tx.service?.name ?? '—'}</td>
                          <td className="py-3 font-mono text-zinc-200">{formatUSDT(tx.amount)}</td>
                          <td className="py-3">
        ...
        <div className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Separator />
              <div>
                <p className="text-xs text-zinc-500">Transaction Limit</p>
              ...
              <div>
                ...
                <p className="mt-1 text-lg font-bold text-white">{formatUSDT(agent.dailyLimit)}</p>
          ...
          <div className="rounded-xl border border-violet-500/20 bg-violet-500/5 p-4 text-xs text-zinc-400">
